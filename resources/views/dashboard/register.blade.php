...
<head>
    ...
    <title>Kokonseran Admin - Register</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="/admin/register" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="password" name="password_confirmation"" class="form-control form-control-user @error('password_confirmation') is-invalid @enderror" id="password_confirmation"
